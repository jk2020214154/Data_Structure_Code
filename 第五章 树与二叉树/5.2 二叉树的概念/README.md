...
故 叶子结点树为 $n_0=\frac{n+1}{2}$,分支结点为 $n-n_0=n-\frac{n+1}{2}=\frac{n-1}{2}$,高度为$\left \lceil \log _2 (n+1) \right \rceil=\log _2 (n+1)$(此处由于 $n+1$必定是 $2$的指数倍,可去掉上取整符)或 $\left \lfloor \log _2 (n) \right \rfloor +1$
